...
public class DataListingEventPayloadActivity
    : Processor
{
	public DataListingEventPayloadActivity(PackageEventHousehold packageEventHousehold, PackageEventHouseholdSynch packageEventHouseholdSynch) 
	{
    ...
    {
        get { return "Data Listing Payload Synchronisation"; }
    }
}
