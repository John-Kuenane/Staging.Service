...
public class PackageEventHouseholdAttribute
    : Entity
{
    ...
    protected PackageEventHouseholdAttribute()
    {
    }

    public PackageEventHouseholdAttribute(string attributeKey, AttributeValue original)
    {
